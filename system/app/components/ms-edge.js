    ...
    setTimeout(() => {
      $(".ms_edge_window").children().fadeOut(() => {
        $(".ms_edge_window").empty().removeClass("d-flex justify-content-center align-items-center").append(`<div class="card-header ms_edge_window_header border-bottom-0 d-flex align-items-center p-0" style="height:25px;">
          &nbsp;<img style="height:15px;"src="https://raw.githubusercontent.com/Kenan862/System-Assets/main/edge.png"/>&nbsp;<div class="card p-1 border-bottom-0 border-info rounded-0 d-flex justify-content-center" style="height:100%; width:150px;">
          <small>Welcome
